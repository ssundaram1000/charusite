					...
					<article class="project-item dc">
						...
						<div class="sr-only project-description" data-images="images/dc/unity-01.jpg,images/dc/balance-01.jpg,images/dc/rhythm-01.jpg,images/dc/proportion-01.jpg" >
							...
							<h2>Requirement</h2>
							<p>
								Using abstract shapes, create a series of compositions that represent the elements of design: unity, balance, rhythm, and proportion.Experiment with placement and cropping to achieve a harmonious balance in each composition.
							</p>
							
							<h2>TECHNIQUES USED</h2>
							<p>
								<ul>
									<li><strong>Unity: </strong>Connected the four items using the film strip. Used proximity, repetition and continuation to unify the objects. Left a lot of negative space to enhance the appearance of unity.</li>
									<li><strong>Rhythm: </strong>Used repetitive and variation of objects and colors to show rhythmic movement. </li>
									<li><strong>Balance: </strong>Used symmetrical balance with equal weight images (color and overall image size) on left and right.</li>
									<li><strong>Proportion: </strong>Used the golden rectangle to focus eye on the projector. Used muted colors for the many other items on the left.</li>
								</ul>
							</p>
